      ...
      child: SafeArea(
        child: userAsync.when(
          ...
          data: (user) {
            ...
            final commonMenu = [
              const _DrawerItem(
                  'Teachers', Icons.school_outlined,
                  '/teachers/directory'),
              const _DrawerItem(
      ...
      case UserRole.admin:
        return _RoleMenu('Admin Menu', [
          ...
          const _DrawerItem(
              ...
              '/admin/users'),
          const _DrawerItem(
              'Queries', Icons.question_answer,
              '/admin/queries'),
          const _DrawerItem(
              'Timetable', Icons.edit_calendar,
              '/admin/timetable'),
          const _DrawerItem(
              'Attendance Overrides', Icons.edit_note,
              '/admin/attendance-overrides'),
          const _DrawerItem(
              'Marks Overrides', Icons.grade,
              '/admin/internal-marks-overrides'),
          const _DrawerItem(
              'Reset Passwords', Icons.lock_reset,
      ...
      case UserRole.teacher:
        return _RoleMenu('Teacher Menu', [
          const _DrawerItem(
              ...
              isHome: true),
          const _DrawerItem(
              'Internal Marks', Icons.grading,
              '/teacher/internal-marks'),
          // FIXED ROUTE PATH HERE
          const _DrawerItem(
              'Remarks Board',
              Icons.label_important_outline,
              '/teacher/remarks-board'),
        ]);
      ...
      case UserRole.student:
        return _RoleMenu('Student Menu', [
          ...
          const _DrawerItem(
              ...
              '/student/timetable'),
          const _DrawerItem(
              'Raise Query', Icons.live_help_outlined,
              '/student/raise-query'),
        ]);
    }
  }
